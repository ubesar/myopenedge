...
const plans = [
  {
    ...
    price: "$0",
    period: "/forever",
    description: "Mulai eksplorasi AMT analysis dengan fitur dasar.",
    features: [
      "IB Analysis (limited)",
  ...
  },
  {
    ...
    price: "$29",
    period: "/month",
    description: "Untuk trader serius yang butuh edge maksimal.",
    features: [
  ...
  },
  {
    ...
    price: "$99",
    period: "/month",
    description: "Solusi lengkap untuk tim dan institusi.",
    features: [
      "Semua fitur Pro",
      "Multi-user access",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-20 pb-12 px-6 text-center">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto text-lg">
          Pilih plan yang sesuai dengan kebutuhan trading Anda. Upgrade atau downgrade kapan saja.
        </p>
      </section>
