...
const ParameterPanel = ({
  ...
  const [lookback, setLookback] = useState<MomentumLookback>("3");
  const [momentumSL, setMomentumSL] = useState<MomentumSL>("2");
  const [momentumTP, setMomentumTP] = useState<MomentumTP>("4");
